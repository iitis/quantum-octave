...
%% Function @code{Measure} performs ortogonal measurment 
%% on state @var{state}. Function returns a probability distribution 
%% of results. 
%%
%% @example 
%% @group
...
% TODO test if state is valid state 
% and if observables are in form 'XYZZYXI'
...
%*	projection
	...
	prob(j+1).p = p;
	cumprob = cumprob+p; % to draw state
